...
const factoryAddress = "0x557a39105A2868Eb300814ac6a14DA174bFe20fC";
        ...
        <div className="flex gap-6 items-center">
          ...
          <button className="text-sm bg-purple-600 font-bold rounded-lg p-2">
            <a
              target="_blank"
              href={
                "https://sepolia-blockscout.scroll.io/address/" + ownerAddress
              }
            >
              View on Scroll(Sepolia)
            </a>
          </button>
        ...
        <div className="flex gap-4 items-center">
          ...
          <button className="text-sm bg-purple-600 font-bold rounded-lg p-2 mt-4">
            <a
              target="_blank"
              href={
                "https://sepolia-blockscout.scroll.io/address/" +
                contractAddress
              }
            >
              View on Scroll(Sepolia)
        ...
        <div className="flex items-center">
          ...
          <button className="text-sm bg-purple-600 font-bold rounded-lg p-2 ">
            <a
              target="_blank"
              href={
                "https://sepolia-blockscout.scroll.io/address/" + factoryAddress
              }
            >
              View on Scroll(Sepolia)
            </a>
