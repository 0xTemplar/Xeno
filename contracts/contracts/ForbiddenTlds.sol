...
contract ForbiddenTlds is Context {
  ...
  constructor(address _xenoDomainHub) {
    forbidden[".eth"] = true;
    forbidden[".net"] = true;
    forbidden[".xyz"] = true;
    forbidden[".com"] = true;
    forbidden[".org"] = true;
    xenoDomainHub = _xenoDomainHub;
  }
  ...
  function _isHubAdmain() internal {
    require(IXenoDomainHub(xenoDomainHub).checkHubAdmin(_msgSender()), "Not Hub Admin");
  }
}
