...
import "./XenoDomainSBT.sol";

/// @title Xeno Domain Factory
/// @author 0xTemplar
/// @notice Factory contract dynamically new domain contracts.
contract XenoDomainSBTFactory is IXenoDomainFactory, ReentrancyGuard, Context{
  ...
  IXenoDomainHub public domainHub;
  ...
  function _createTld(
   ...
   XenoDomainSBT tld = new XenoDomainSBT(
      _name, 
      _symbol, 
      _tldOwner, 
      _domainPrice, 
